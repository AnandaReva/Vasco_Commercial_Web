 ...
 */
    ...
    public function updateData($transactionId)
    {
        ...
        $transactionUpdate = Transaction::findOrFail($transactionId);
      ...
      //  dd($productImageUrl);
        ...
        try {
            ...
            Mail::to($userEmail)->send(new receiptEmail($product_name, $colorName, $sizeName, $qty, $total_price, $status, $productImageUrl));
        } catch (\Throwable $th) {
