                ...
                @foreach ($productsList as $product)
                    ...
                    <td class="px-6 py-4 whitespace-nowrap border-b">
                        <div class="flex">
                            {{-- Edit action --}}
                            <div class="flex">
                                <a href="{{ route('productAdmin.edit', ['idProduct' => $product->id]) }}" class="text-blue-500 hover:underline mr-2">
                            ...
                            <div class="flex pl-2">
                                {{-- Delete action --}}
                                <button
                                    onclick="confirmDelete('{{ route('productAdmin.destroy', ['idProduct' => $product->id]) }}')"
                                ...
                                <script>
                                    function confirmDelete(deleteUrl) {
                                        var confirmation = confirm(
                                            "Are you sure you want to delete this product? Entire variants and available sizes will be deleted as well."
                                        );
