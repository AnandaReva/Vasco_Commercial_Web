...
<body class="bg-gray-100">
    ...
    <form
        action="{{ route('availableSizeAdmin.store', ['idProduct' => $idProduct, 'idVariants' => implode(',', $idVariants)]) }}"
        method="post">
            ...
            <table>
                ...
                <tbody id="sizeInput{{ $idVariant }}" class="bg-white divide-y divide-gray-200">
                    <tr id="templateRow" style="display: none;">
                        ...
                        <td>
                            <input class="border p-2 rounded-md" type="number" name="price[{{ $idVariant }}]"
                                placeholder="Price" >
                        </td>
                        <td>
                        ...
                        <td>
                            <input class="border p-2 rounded-md" type="number" name="weight[{{ $idVariant }}]" placeholder="weight">
                        </td>
                    </tr>
                </tbody>
            </table>
