...
<body>
    ...
    <table style="width:100%; border-collapse: collapse; margin-top: 20px;">
        ...
        <tr>
            ...
            <td style="border: 1px solid #dddddd; text-align: left; padding: 8px;"> <strong>
    ...
    <table style="width:100%; border-collapse: collapse; margin-top: 20px;">
        ...
        <tr>
            <th style="border: 1px solid #dddddd; text-align: left; padding: 8px;">destianation Adreess</th>
