        ...
        <div id="favoritesCarousel">
            <div class="flex justify-center">
                ...
                <div class="flex space-x-4">
                    <div>
                        <img id="caroAfterPrev" src="{{ asset('/product_resources/Misc/denimPants.png') }}" class="carousel-image hidden d-block w-100 opacity-60"
                            alt="...">
                    </div>
                    <div class="">
                    ...
                    <div>
                        <img id="caroCurrent" src="{{ asset('/product_resources/Misc/waffleLong.png') }}" class="carousel-image d-block opacity-90 w-100 hover:opacity-100 transition ease-in duration-300"
                            alt="...">
                    </div>
                    <div>
                        <img id="caroNext" src="{{ asset('/product_resources/Misc/yellowShirt.png') }}" class="carousel-image ease d-block w-100 opacity-60 hover:opacity-100 transition ease-in duration-300"
                            alt="...">
                    </div>
                    <div>
                        <img id="caroAfterNext" src="{{ asset('/product_resources/Misc/denJack.png') }}" class="carousel-image hidden d-block w-100 opacity-75"
                            alt="...">
                    </div>
                </div>
